...
class TestApiKeySupport:
    def test_accepts_api_key_flag(self) -> None:
        assert DETECTOR_MAP["sonarr"].accepts_api_key is True
        assert DETECTOR_MAP["radarr"].accepts_api_key is True
        assert DETECTOR_MAP["prowlarr"].accepts_api_key is True
        assert DETECTOR_MAP["bazarr"].accepts_api_key is True
        assert DETECTOR_MAP["overseerr"].accepts_api_key is True
        assert DETECTOR_MAP["sabnzbd"].accepts_api_key is True
